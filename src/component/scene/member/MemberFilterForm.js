...
class MemberFilterForm extends Component{
    constructor(props){
        super(props);
        this.state = {
            fieldDef:{
    ...
    render(){
        ...
        console.log('~~haha~~',this.props.config);
...
MemberFilterForm = localize()(FormBaseHoc(MemberFilterForm))
MemberFilterForm=reduxForm({
